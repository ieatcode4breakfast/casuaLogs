...
Logify is a **local-first PWA**. The browser is the primary database. The cloud is cold backup. Every architectural decision defers to this constraint: a user offline should have zero feature degradation.
